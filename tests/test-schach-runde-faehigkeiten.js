/*
 * test-schach-runde-faehigkeiten.js — Regressionstests der Fähigkeiten,
 * Lootboxen, Unglückswürfel und des Händlers einer Partie.
 *
 * Aus test-schach-runde.js herausgelöst (08/2026), entlang derselben Naht
 * wie der App-Code seit v0.92.0: Dort blieb die Rundenverwaltung in
 * js\schach-runde.js, und js\schach-runde-faehigkeiten.js ergänzt sie um
 * Fähigkeiten, Lootboxen und Händler. Die Prüfungen sind unverändert
 * umgezogen — hier stehen die zur Ergänzung, die Rundenverwaltung prüft
 * weiter test-schach-runde.js.
 *
 * Geladen wird DIESELBE echte Dateikette wie dort: schach-varianten,
 * schach, schach-runde, schach-runde-faehigkeiten — schach-runde.js benutzt
 * SCHACH als globale Größe, genau wie im Browser, deshalb wird es vorher
 * bereitgestellt; die Ergänzung lädt NACH schach-runde.js.
 */
...
/*
 * Aus test-schach-runde.js mitgenommen: Der Test „Keine Lootbox auf einem
 * Riss oder unter einer Mauer" braucht eine Zufallsarmee-Partie; der
 * Helfer dafür wohnt (mit den übrigen Zufallsarmee-Prüfungen) weiter dort
 * und steht hier als Zweitausgabe.
 */
/*
